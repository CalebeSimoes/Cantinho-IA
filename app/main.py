...
app=FastAPI(title='🌿 Cantinho Ghibli AI',version='3.2.0',description='Notion Inbox + Router + Ollama local + 5 áreas')
@app.get('/')
def root(): return {'app':'Cantinho Ghibli AI','version':'3.2.0','docs':'/docs'}
@app.get('/health')
